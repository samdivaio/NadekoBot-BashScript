...
if [ $choice -eq 1 ] ; then
	...
	wget -N https://cdn.discordapp.com/attachments/287982972664020994/325603867431534603/1.4-new.sh && bash 1.4-new.sh
	echo ""
	...
	bash linuxAIO.sh
		...
		if [ $choice -eq 2 ] ; then
			...
			wget -N https://github.com/samdivaio/NadekoBot-BashScript/raw/1.5/nadeko_run.sh && bash nadeko_run.sh
			echo ""
